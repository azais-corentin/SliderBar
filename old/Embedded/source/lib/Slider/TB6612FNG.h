...
// values until it does.  These will also take a negative number and go
// backwards  There is also an optional speed input, if speed is not used, the
// function will  use the DEFAULTSPEED constant.
void forward(Motor motor1, Motor motor2, int speed);
void forward(Motor motor1, Motor motor2);

// Similar to forward, will take 2 motors and go backwards.  This will take
// either  a positive or negative number and will go backwards either way.  Once
// again the  speed input is optional and will use DEFAULTSPEED if it is not
// defined.
